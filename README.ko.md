...
- **담당 역할:** 전체 기능 설계 및 프론트엔드 구현, Firebase 기반 백엔드 구축, 배포
...
## 📎 기타 정보
본 문서는 주요 기능, 구조, 핵심 기술 중심으로 구성되어 있으며,  
개발 배경 및 문제 해결 과정, 배운 점은 [포트폴리오 사이트](https://mesel7.dev/projects/seremeety)에서 확인하실 수 있습니다.
